...
class Controller(XSSerReporter):
    ...
    def on_quit(self, widget, data=None):
        ...
        """
        if self._flying:
            print("Exiting xsser... please wait until all mosquitos return to mothership!")
            self._quitting = True
            self.on_stop_attack()
            self.do_quit()
        else:
